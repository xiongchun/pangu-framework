export default {
	...
	login: {
		...
		signInTitle: 'Sign in',
		accountLogin: 'Account password sign in',
		mobileLogin: 'Mobile sms sign in',
		rememberMe: 'Remember me 8 hours',
		...
		demoAccount:' Or login with demo account: admin/123456.',
