	...
	<el-dialog :title="titleMap[mode]" v-model="visible" :width="450" destroy-on-close @closed="$emit('closed')">
		<el-form :model="form" :rules="rules" :disabled="mode == 'show'" ref="dialogForm" label-width="80px"
			...
			<el-form-item label="新密码" prop="password">
				<el-input type="password" v-model="form.password" placeholder="请输入新密码" maxlength="20" clearable
			...
			<el-form-item label="确认密码" prop="password2">
				<el-input type="password" v-model="form.password2" placeholder="请再次输入新密码" maxlength="20" clearable
					show-password></el-input>
			</el-form-item>
		</el-form>
		<template #footer>
