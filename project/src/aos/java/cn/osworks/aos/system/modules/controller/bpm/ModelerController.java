...
import cn.osworks.aos.system.modules.service.bpm.ModelerService;
...
public class ModelerController {
    ...
    public void retrieveBeforeSave(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (AOSUtils.isNotEmpty(modelId)){
            ...
            if (AOSUtils.isNotEmpty(aos_sys_wf_modelPO)) {
                name = aos_sys_wf_modelPO.getName_();
                description = aos_sys_wf_modelPO.getRemark_();
            }
        }
