...
public class UserService {
	...
	public String saveUserPhoto(Dto inDto) throws IOException {
		...
		if (AOSUtils.isEmpty(aos_sys_bytearrayMapper.selectByKey(bytearray_id_))) {
			...
			Aos_sys_user_extPO aos_sys_user_extPO = aos_sys_user_extMapper.selectByKey(inDto.getString("id_"));
			aos_sys_user_extPO.setBytearray_id_(bytearray_id_);
			aos_sys_user_extMapper.updateByKey(aos_sys_user_extPO);
		} else {
			// 修改上传
			Aos_sys_bytearrayPO aos_sys_bytearrayPO = aos_sys_bytearrayMapper.selectByKey(bytearray_id_);
	...
	public void delUserPhoto(Dto inDto) {
		...
		aos_sys_bytearrayMapper.deleteByKey(aos_sys_user_extPO.getBytearray_id_());
		aos_sys_user_extPO.setBytearray_id_("");
		aos_sys_user_extMapper.updateByKey(aos_sys_user_extPO);
	}
	...
	public Dto saveUser(Dto inDto) {
		...
		aos_sys_userPO.setId_(AOSId.id(IdCons.USERID));
	...
	public void saveUserModuleGrantInfo(Dto pDto) {
		...
		for (String module_id_ : selections) {
			aos_sys_module_userPO.setId_(AOSId.id(IdCons.RID));
	...
	public void saveUserPostGrantInfo(Dto pDto) {
		...
		for (String post_id_ : selections) {
			aos_sys_user_postPO.setId_(AOSId.id(IdCons.RID));
	...
	public void saveUserRoleGrantInfo(Dto pDto) {
		...
		for (String role_id_ : selections) {
			aos_sys_user_rolePO.setId_(AOSId.id(IdCons.RID));
