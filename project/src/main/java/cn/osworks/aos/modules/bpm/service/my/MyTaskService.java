package cn.osworks.aos.modules.bpm.service.my;
...
import cn.osworks.aos.modules.bpm.service.BpmService;
...
public class MyTaskService {
	...
	public Dto claimTask(Dto inDto){
		...
		bpmService.claim(inDto.getString("id_"), inDto.getUserInfo().getId_());
	...
	public Dto unClaimTask(Dto inDto){
		Dto outDto = Dtos.newOutDto();
		bpmService.unclaim(inDto.getString("id_"));
