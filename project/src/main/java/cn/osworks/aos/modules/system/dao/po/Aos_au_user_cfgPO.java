...
/**
 * <b>用户配置表[aos_au_user_cfg]数据持久化对象</b>
 * <p>
 * 注意:此类代码自动生成-禁止手工修改。
 * </p>
 * 
 * @author OSWorks-XC
 * @date 2015-03-25 23:52:10
 */
public class Aos_au_user_cfgPO extends PO {
	 ...
	 * 欢迎页Mac导航显示开关
	 */
	private String is_show_mac_nav_;
	 ...
	 * 快捷菜单布局风格
	 */
	private String nav_quick_layout_;
	 ...
	 * 欢迎页Mac导航显示开关
	 * 
	 * @return is_show_mac_nav_
	 */
	public String getIs_show_mac_nav_() {
		return is_show_mac_nav_;
	}
	 ...
	 * 快捷菜单布局风格
	 * 
	 * @return nav_quick_layout_
	 */
	public String getNav_quick_layout_() {
		return nav_quick_layout_;
	}
	 ...
	 * @param layout_
	 */
	public void setLayout_(String layout_) {
	 ...
	 * @param nav_mode_
	 */
	public void setNav_mode_(String nav_mode_) {
		this.nav_mode_ = nav_mode_;
	}
	 ...
	 * 欢迎页Mac导航显示开关
	 * 
	 * @param is_show_mac_nav_
	 */
	public void setIs_show_mac_nav_(String is_show_mac_nav_) {
		this.is_show_mac_nav_ = is_show_mac_nav_;
	}
	 ...
	 * 快捷菜单布局风格
	 * 
	 * @param nav_quick_layout_
	 */
	public void setNav_quick_layout_(String nav_quick_layout_) {
		this.nav_quick_layout_ = nav_quick_layout_;
	}
