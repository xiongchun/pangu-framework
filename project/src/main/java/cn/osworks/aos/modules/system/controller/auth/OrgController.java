...
import cn.osworks.aos.modules.system.service.auth.OrgService;
...
public class OrgController {
	...
	public void listOrgs(HttpServletRequest request, HttpServletResponse response) {
		...
		List<Aos_au_orgPO> aos_au_orgPOs = sqlDao.list("Auth.listAos_au_orgPOsPage", qDto);
		String outString = AOSJson.toGridJson(aos_au_orgPOs, qDto.getPageTotal());
