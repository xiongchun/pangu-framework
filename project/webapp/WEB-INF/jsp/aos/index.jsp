	...
	<div id="_id_north_el" class="x-hidden north_el">
		<table>
			<tr>
				...
				<td align="left" width="60%"><c:if test="${navDto.is_show_top_nav_ == 'true' }">
				...
				<td align="right" style="padding: 5px">
					<table style="border-spacing: 3px;">
						...
						<tr>
						<tr align="right">
							<td><a class="${navDto.right_button_style}" onmouseout="_btn_onmouseout(this)"
								onmouseover="_btn_onmouseover(this);"><i class="fa fa-bell-o"></i> 消息</a> <a
			...
			<aos:tab title="快捷菜单" layout="fit">
				...
				<c:if test="${nav_quick_layout_ == '1' }">
					<aos:menu floating="false" plain="false" border="false" >
						<c:forEach var="module" items="${aos_au_modulePOs}">
