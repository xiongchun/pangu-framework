...
<aos:onready>
	...
	<script type="text/javascript">
		...
		function _g_task_query() {
			var params = {
				proctask_status_ : App.val('proctask_status_'),
				name_ : App.val('name_')
			};
		...
		function _fn_delProcTask() {
			var rec = App.selectone(_g_task); 
			var msg = App.merge('确认要删除流程任务[ID:{0}, 名称:{1}]吗？', rec.data.id_, rec.data.name_);
