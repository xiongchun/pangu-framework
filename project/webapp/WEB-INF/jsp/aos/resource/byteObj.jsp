    ...
    <aos:onready>
        <aos:viewport layout="border">
            ...
            <aos:gridpanel id="_g_byteobj" url="listByteObjs.jhtml" region="center" onrender="_g_byteobj_query"
                ...
                <aos:column header="标识键" dataIndex="key_" width="150" celltip="true"/>
        ...
        <aos:window id="_w_view" title="查看/下载" autoScroll="true" onshow="_w_view_onshow"
            ...
            <aos:docked dock="bottom" ui="footer">
                <aos:dockeditem xtype="tbfill"/>
                <aos:dockeditem onclick="_fn_downlod" text="下载" icon="arrow_down.png"/>
        ...
        <script type="text/javascript">
            ...
            function _w_view_onshow() {
                var record = App.selectone(_g_byteobj);
            ...
            //新增流文件保存(注：文件上传操作不能使用App.Ajax()方法，只能使用Form自带的submit()函数)。
            ...
            function _g_byteobj_del() {
                var selection = App.selection(_g_byteobj, 'id_');
                if (App.empty(selection)) {
                    App.tip('删除前请先选中数据。');
                    return;
                }
                var rows = App.rows(_g_byteobj);
