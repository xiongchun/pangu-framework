...
ORYX.I18N.Save.pleaseWait = "正在处理您的请求，请稍后...";
...
//保存模型的出错提示信息
ORYX.I18N.Save.failed = "保存模型数据时出错，请与系统管理员联系。";
ORYX.I18N.Save.exception = "保存模型数据时出错，请与系统管理员联系。";
ORYX.I18N.Save.retrieveData = "正在处理您的请求，请稍后...";
