...
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:gridpanel id="_g_account" url="demoService.listAccounts" onrender="_g_account_query" region="center" any="features : [{
ftype : 'summary',
dock : 'bottom'
}
]">
			...
			<aos:column type="rowno" />
				...
				<aos:column header="持卡人" dataIndex="name_" width="80" any="summaryType: 'count'" />
				...
				<aos:column header="年龄" dataIndex="age_" width="60" any="summaryType: 'max'"  />
