...
<aos:body>
	<div id="div_vercode" class="x-hidden" align="center">
		<aos:vercode id="id_vercode" uuid="${vercode_uuid_}" fontSize="28" length="5" width="120" />
	</div>
	<div id="_div_photo" class="x-hidden" align="center">
		<img id="_img_photo" class="app_cursor_pointer" src="${cxt}/static/image/empty_head_photo.png" width="200" height="200">
	</div>
</aos:body>
</aos:html>
	...
	<aos:viewport layout="border">
		<aos:tabpanel id="_id_tabs" region="center" tabPosition="bottom" bodyBorder="0 0 0 0" margin="0 0 2 0">
			...
			<aos:tab title="基本表单元素">
				<aos:formpanel id="_f_info" autoShow="true" width="650" layout="column" labelWidth="70" msgTarget="qtip">
					<%-- 隐藏变量 --%>
					<aos:hiddenfield name="id_" value="001" />
					<aos:fieldset title="文本输入" labelWidth="70" columnWidth="1" border="true">
						<aos:textfield name="card_id_" fieldLabel="卡号" maxLength="10" allowBlank="false" columnWidth="0.25" />
					...
					<aos:fieldset title="数字输入" labelWidth="70" columnWidth="1" border="true">
						<aos:numberfield name="credit_line_" fieldLabel="信用额度" minValue="0" maxValue="100000" value="100000" allowBlank="false" columnWidth="0.5" />
					...
					<aos:fieldset title="日期时间输入" labelWidth="70" columnWidth="1" border="true">
						<aos:datefield name="birthday_" fieldLabel="出生日期" format="Y年m月d日" value="2015-03-10" editable="true" columnWidth="0.33" />
						<aos:datefield name="start_time_" fieldLabel="起始日期" value="2015-03-10" format="Y-m-d 00:00:00" editable="false" columnWidth="0.33" />
						<aos:datefield name="end_time_" fieldLabel="截止日期" format="Y-m-d 23:59:59" editable="false" maxValue="${maxValue}" disabledDaysText="测试" minValue="${minValue}"
							columnWidth="0.33" />
						<aos:datefield name="disable_date_" fieldLabel="审批日期" disabledDays="0,6" disabledDaysText="不能选择周末做为审批日期" editable="false" columnWidth="0.33" />
						<aos:timefield name="reg_time_" fieldLabel="签到时间" editable="false" value="09点00分" increment="15" maxValue="18点00分" columnWidth="0.33" />
						<aos:datetimefield name="datetime_" fieldLabel="经办时间" editable="false" columnWidth="0.33" />
					</aos:fieldset>
					...
					<aos:fieldset title="常规下拉选择框" labelWidth="100" columnWidth="1" border="true">
						<aos:combobox fieldLabel="客户端数据源" name="bank_" value="1" columnWidth="0.33">
						...
						<aos:combobox fieldLabel="字典数据源" name="card_type_" dicField="card_type_" columnWidth="0.33" />
						<aos:combobox fieldLabel="自定义数据源" name="name2" editable="false" columnWidth="0.33" url="demoService.listComboBoxData" />
						<aos:combobox fieldLabel="可输入" name="card_type_2_" dicField="card_type_" editable="true" columnWidth="0.33" />
			...
			<aos:tab title="常用表单API" layout="anchor" autoScroll="true">
				<aos:formpanel id="_form1" layout="column" labelWidth="60" title="表单1：个人信息" border="true" anchor="100%" margin="5">
					<aos:docked>
					...
					<aos:textfield fieldLabel="姓名" name="name_" value="凤姐" allowBlank="false" columnWidth="0.5" />
				...
				<aos:formpanel id="_form2" layout="column" labelWidth="60" title="表单2：机构信息" border="true" anchor="100%" margin="5">
					<aos:docked>
				...
				<aos:formpanel id="_form4" layout="column" labelWidth="80" title="表单4：表单校验" border="true" anchor="100%" margin="5">
					...
					<aos:textfield id="_id_name2" fieldLabel="姓名" name="name_" allowBlank="false" columnWidth="0.5" />
					...
					<aos:docked dock="bottom" ui="footer" padding="0 0 5 0">
						...
						<aos:dockeditem xtype="button" text="重置" onclick="#_form4.form.reset()" icon="refresh.png" />
						<aos:dockeditem xtype="tbfill" />
					</aos:docked>
				</aos:formpanel>
			</aos:tab>
			...
			<aos:tab title="表单数据交互" layout="anchor" autoScroll="true">
				<aos:formpanel id="id_form_data1" layout="column" labelWidth="70" title="表单1：前端数据交互" anchor="100%" border="true" margin="5">
					<aos:docked>
						...
						<aos:dockeditem xtype="tbseparator" />
						<aos:dockeditem xtype="button" text="重置" onclick="#AOS.reset(id_form_data1)" icon="refresh.png" />
					</aos:docked>
					<aos:textfield fieldLabel="姓名" name="name_" allowBlank="false" columnWidth="0.25" />
					<aos:textfield fieldLabel="年龄" name="age_" columnWidth="0.25" />
					<aos:combobox name="sex_" fieldLabel="性别" dicField="sex_" columnWidth="0.25" />
					<aos:datefield name="birthday_" fieldLabel="出生日期" columnWidth="0.25" />
					...
					<aos:textfield fieldLabel="家庭住址" name="home_" columnWidth="0.75" />
					<aos:datetimefield name="operateTime_" editable="false" fieldLabel="经办时间" columnWidth="0.25" />
				</aos:formpanel>

				<aos:formpanel id="id_form_data2" layout="column" labelWidth="70" title="表单2：后端数据交互" anchor="100%" border="true" margin="5" collapsible="true">
					<aos:docked>
					...
					<aos:textfield fieldLabel="年龄" name="age_" columnWidth="0.25" />
					<aos:combobox name="sex_" fieldLabel="性别" dicField="sex_" columnWidth="0.25" />
					<aos:datefield name="birthday_" fieldLabel="出生日期" format="Y-m-d" columnWidth="0.25" />
					<aos:checkboxgroup fieldLabel="性格特点" columns="[120,80,120,120]" columnWidth="0.5">
						<aos:checkbox name="c1" boxLabel="活波开朗" inputValue="1" />
						<aos:checkbox name="c1" boxLabel="闷骚" inputValue="2" />
						<aos:checkbox name="c1" boxLabel="傻*250一个" inputValue="3" />
				...
				<aos:formpanel id="id_form_data3" layout="column" labelWidth="70" title="表单2：后端数据交互(表单同步提交)" standardSubmit="true" anchor="100%" border="true" margin="5">
					...
					<aos:textfield fieldLabel="姓名" name="name_" allowBlank="false" value="凤姐" columnWidth="0.25" />
					<aos:textfield fieldLabel="年龄" name="age_" value="18" columnWidth="0.25" />
			...
			<aos:tab title="常用表单布局" layout="anchor" autoScroll="true">
				<aos:formpanel title="常用布局1" layout="column" labelWidth="70" margin="5" anchor="100%" border="true">
					...
					<aos:textfield fieldLabel="姓名" name="name_" columnWidth="0.25" allowBlank="false" />
					<aos:numberfield fieldLabel="年龄" name="age_" minWidth="1" maxValue="120" columnWidth="0.25" />
					<aos:textfield fieldLabel="身份证号" name="id_no_" columnWidth="0.25" />
					<aos:textfield fieldLabel="所属银行" name="org_id_" columnWidth="0.25" />
				...
				<aos:formpanel title="常用布局3" layout="column" labelWidth="70" margin="5" anchor="100%" border="true">
					...
					<aos:fieldset title="用户头像" labelWidth="70" columnWidth="0.35" contentEl="_div_photo" height="200" />
		...
		<aos:window id="_w_org_find" title="上级模块[双击选择]" height="-60" layout="fit" autoScroll="true" onshow="_t_org_find_refresh">
			<aos:treepanel id="_t_org_find" singleClick="false" width="320" bodyBorder="0 0 0 0" url="demoService.getTreeData" rootVisible="false" onitemdblclick="_t_org_find_select" />
		</aos:window>
	 ...
	 function checkGroupChange(me,newValue){
		...
		function loadData() {
	        AOS.ajax({
	            ...
	            ok: function (data) {
	            	AOS.setValues(id_form_data2,data);
	            }
	        });
		}
		...
		function submitSync2() {
			//获取表单值
			//var myParams = id_form_data2.getValues();
			// 这种方式不会对表单进行验证，可以自己验证
			if(!id_form_data2.isValid()) return;
			var myParams = {};
			//这样可以增加参数
			myParams.name = 'mowen';
			myParams.sex = '2';
		...
		function submitAsync() {
			if(!id_form_data3.isValid()) return;
			id_form_data3.getForm().submit({
	   ...
	   //赋值
	   function setValue(){
		   AOS.reset(id_form_data1);
		   AOS.setValue('id_form_data1.name_', '王菲'); //文本框
		   AOS.setValue('id_form_data1.birthday_', '1982-11-17'); //日期时间
		   AOS.setValue('id_form_data1.sex_', '1'); //下拉项
		   AOS.setValue('id_form_data1.c1', ['1','2']); //复选框
		   AOS.setValue('id_form_data1.r1', '2'); //单选框
	   }
	   
	   //取值
	   function getValue(){
		   var values = {};
		   values.name_= AOS.getValue('id_form_data1.name_');
		   values.sex_= AOS.getValue('id_form_data1.sex_');
	   ...
	   function setValues(){
		   ...
		   var values = {
				   name_:'周迅',
				   sex_:'2',
				   birthday_:'1983-12-22',
				   c1:['1','2','3','4'],
				   r1:'1'
		   };
		   AOS.setValues(id_form_data1, values); 
	   }
	   
	  //批量取值
	   function getValues(){
		  var values = id_form_data1.getValues();
		...
		function _t_org_find_select() {
			...
			AOS.setValue('_f_info.parent_id_',record.raw.id);
			AOS.setValue('_f_info.parent_id_desc',record.raw.text);
			_w_org_find.hide();
		}
		...
		//只读
		function fn1() {
			AOS.reads(_form1, 'cardno_,name_');
		}

		//取消只读
		function fn2() {
			AOS.edits(_form1, 'cardno_,name_');
		}

		//禁用
		function fn3() {
			AOS.disables(_form1, 'cardno_,age_,sex_,name_');
		}

		//取消禁用
		function fn4() {
			AOS.enables(_form1, 'cardno_,age_,sex_,name_');
		}
