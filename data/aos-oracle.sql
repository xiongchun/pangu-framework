...
-- Created by XChun on 2015/7/5, 21:31:58 --
--------------------------------------------
...
prompt ==============================
prompt
create table AOS.AOS_ACT_EVT_LOG
(
...
;
alter table AOS.AOS_ACT_EVT_LOG
...
prompt ====================================
prompt
create table AOS.AOS_ACT_RE_DEPLOYMENT
(
...
;
alter table AOS.AOS_ACT_RE_DEPLOYMENT
  add primary key (ID_);
...
prompt ===================================
prompt
create table AOS.AOS_ACT_GE_BYTEARRAY
(
  id_            NVARCHAR2(64) not null,
  rev_           INTEGER,
  name_          NVARCHAR2(255),
...
;
create index AOS.AOS_ACT_IDX_BYTEAR_DEPL on AOS.AOS_ACT_GE_BYTEARRAY (DEPLOYMENT_ID_);
alter table AOS.AOS_ACT_GE_BYTEARRAY
  add primary key (ID_);
alter table AOS.AOS_ACT_GE_BYTEARRAY
  add constraint AOS_ACT_FK_BYTEARR_DEPL foreign key (DEPLOYMENT_ID_)
  references AOS.AOS_ACT_RE_DEPLOYMENT (ID_);
alter table AOS.AOS_ACT_GE_BYTEARRAY
...
prompt ==================================
prompt
create table AOS.AOS_ACT_GE_PROPERTY
(
...
;
alter table AOS.AOS_ACT_GE_PROPERTY
...
prompt =================================
prompt
create table AOS.AOS_ACT_HI_ACTINST
(
  id_                NVARCHAR2(64) not null,
...
;
create index AOS.AOS_ACT_IDX_HI_ACT_INST_1 on AOS.AOS_ACT_HI_ACTINST (START_TIME_);
create index AOS.AOS_ACT_IDX_HI_ACT_INST_2 on AOS.AOS_ACT_HI_ACTINST (END_TIME_);
create index AOS.AOS_ACT_IDX_HI_ACT_INST_3 on AOS.AOS_ACT_HI_ACTINST (PROC_INST_ID_, ACT_ID_);
create index AOS.AOS_ACT_IDX_HI_ACT_INST_4 on AOS.AOS_ACT_HI_ACTINST (EXECUTION_ID_, ACT_ID_);
alter table AOS.AOS_ACT_HI_ACTINST
  add primary key (ID_);
...
prompt ====================================
prompt
create table AOS.AOS_ACT_HI_ATTACHMENT
(
  id_           NVARCHAR2(64) not null,
  rev_          INTEGER,
  user_id_      NVARCHAR2(255),
...
;
alter table AOS.AOS_ACT_HI_ATTACHMENT
  add primary key (ID_);
...
prompt =================================
prompt
create table AOS.AOS_ACT_HI_COMMENT
(
  id_           NVARCHAR2(64) not null,
  type_         NVARCHAR2(255),
...
;
alter table AOS.AOS_ACT_HI_COMMENT
  add primary key (ID_);
...
prompt ================================
prompt
create table AOS.AOS_ACT_HI_DETAIL
(
  id_           NVARCHAR2(64) not null,
...
;
create index AOS.AOS_ACT_IDX_HI_DETAIL_1 on AOS.AOS_ACT_HI_DETAIL (PROC_INST_ID_);
create index AOS.AOS_ACT_IDX_HI_DETAIL_2 on AOS.AOS_ACT_HI_DETAIL (ACT_INST_ID_);
create index AOS.AOS_ACT_IDX_HI_DETAIL_3 on AOS.AOS_ACT_HI_DETAIL (TIME_);
create index AOS.AOS_ACT_IDX_HI_DETAIL_4 on AOS.AOS_ACT_HI_DETAIL (NAME_);
create index AOS.AOS_ACT_IDX_HI_DETAIL_5 on AOS.AOS_ACT_HI_DETAIL (TASK_ID_);
alter table AOS.AOS_ACT_HI_DETAIL
  add primary key (ID_);
...
prompt ======================================
prompt
create table AOS.AOS_ACT_HI_IDENTITYLINK
(
  id_           NVARCHAR2(64) not null,
...
;
create index AOS.AOS_ACT_IDX_HI_IDENT_LNK_1 on AOS.AOS_ACT_HI_IDENTITYLINK (USER_ID_);
create index AOS.AOS_ACT_IDX_HI_IDENT_LNK_2 on AOS.AOS_ACT_HI_IDENTITYLINK (TASK_ID_);
create index AOS.AOS_ACT_IDX_HI_IDENT_LNK_3 on AOS.AOS_ACT_HI_IDENTITYLINK (PROC_INST_ID_);
alter table AOS.AOS_ACT_HI_IDENTITYLINK
  add primary key (ID_);
...
prompt ==================================
prompt
create table AOS.AOS_ACT_HI_PROCINST
(
  id_                        NVARCHAR2(64) not null,
  proc_inst_id_              NVARCHAR2(64) not null,
...
;
create index AOS.AOS_ACT_IDX_HI_PRO_1 on AOS.AOS_ACT_HI_PROCINST (END_TIME_);
create index AOS.AOS_ACT_IDX_HI_PRO_2 on AOS.AOS_ACT_HI_PROCINST (BUSINESS_KEY_);
alter table AOS.AOS_ACT_HI_PROCINST
  add primary key (ID_);
alter table AOS.AOS_ACT_HI_PROCINST
...
prompt ==================================
prompt
create table AOS.AOS_ACT_HI_TASKINST
(
  id_             NVARCHAR2(64) not null,
  proc_def_id_    NVARCHAR2(64),
...
;
alter table AOS.AOS_ACT_HI_TASKINST
  add primary key (ID_);
...
prompt =================================
prompt
create table AOS.AOS_ACT_HI_VARINST
(
  id_                NVARCHAR2(64) not null,
  proc_inst_id_      NVARCHAR2(64),
  execution_id_      NVARCHAR2(64),
...
;
create index AOS.AOS_ACT_IDX_HI_PROCVAR_1 on AOS.AOS_ACT_HI_VARINST (PROC_INST_ID_);
create index AOS.AOS_ACT_IDX_HI_PROCVAR_2 on AOS.AOS_ACT_HI_VARINST (NAME_, VAR_TYPE_);
create index AOS.AOS_ACT_IDX_HI_PROCVAR_ID on AOS.AOS_ACT_HI_VARINST (TASK_ID_);
alter table AOS.AOS_ACT_HI_VARINST
  add primary key (ID_);
...
prompt ===============================
prompt
create table AOS.AOS_ACT_ID_GROUP
(
  id_   NVARCHAR2(64) not null,
  rev_  INTEGER,
  name_ NVARCHAR2(255),
...
;
alter table AOS.AOS_ACT_ID_GROUP
  add primary key (ID_);
...
prompt ==============================
prompt
create table AOS.AOS_ACT_ID_INFO
(
  id_        NVARCHAR2(64) not null,
  rev_       INTEGER,
...
;
alter table AOS.AOS_ACT_ID_INFO
  add primary key (ID_);
...
prompt ==============================
prompt
create table AOS.AOS_ACT_ID_USER
(
  id_         NVARCHAR2(64) not null,
  rev_        INTEGER,
...
;
alter table AOS.AOS_ACT_ID_USER
  add primary key (ID_);
...
prompt ====================================
prompt
create table AOS.AOS_ACT_ID_MEMBERSHIP
(
  user_id_  NVARCHAR2(64) not null,
  group_id_ NVARCHAR2(64) not null
)
;
create index AOS.AOS_ACT_IDX_MEMB_GROUP on AOS.AOS_ACT_ID_MEMBERSHIP (GROUP_ID_);
create index AOS.AOS_ACT_IDX_MEMB_USER on AOS.AOS_ACT_ID_MEMBERSHIP (USER_ID_);
alter table AOS.AOS_ACT_ID_MEMBERSHIP
  add primary key (USER_ID_, GROUP_ID_);
alter table AOS.AOS_ACT_ID_MEMBERSHIP
  add constraint AOS_ACT_FK_MEMB_GROUP foreign key (GROUP_ID_)
  references AOS.AOS_ACT_ID_GROUP (ID_);
alter table AOS.AOS_ACT_ID_MEMBERSHIP
  add constraint AOS_ACT_FK_MEMB_USER foreign key (USER_ID_)
  references AOS.AOS_ACT_ID_USER (ID_);

prompt
prompt Creating table AOS_ACT_RE_MODEL
prompt ===============================
prompt
create table AOS.AOS_ACT_RE_MODEL
(
  id_                           NVARCHAR2(64) not null,
  rev_                          INTEGER,
  name_                         NVARCHAR2(255),
...
;
create index AOS.AOS_ACT_IDX_MODEL_DEPLOYMENT on AOS.AOS_ACT_RE_MODEL (DEPLOYMENT_ID_);
create index AOS.AOS_ACT_IDX_MODEL_SOURCE on AOS.AOS_ACT_RE_MODEL (EDITOR_SOURCE_VALUE_ID_);
create index AOS.AOS_ACT_IDX_MODEL_SOURCE_EXTRA on AOS.AOS_ACT_RE_MODEL (EDITOR_SOURCE_EXTRA_VALUE_ID_);
alter table AOS.AOS_ACT_RE_MODEL
  add primary key (ID_);
alter table AOS.AOS_ACT_RE_MODEL
...
alter table AOS.AOS_ACT_RE_MODEL
  ...
  references AOS.AOS_ACT_GE_BYTEARRAY (ID_);
alter table AOS.AOS_ACT_RE_MODEL
...
prompt =================================
prompt
create table AOS.AOS_ACT_RE_PROCDEF
(
  id_                     NVARCHAR2(64) not null,
  rev_                    INTEGER,
  category_               NVARCHAR2(255),
...
;
alter table AOS.AOS_ACT_RE_PROCDEF
  add primary key (ID_);
alter table AOS.AOS_ACT_RE_PROCDEF
...
prompt ===================================
prompt
create table AOS.AOS_ACT_RU_EXECUTION
(
  id_               NVARCHAR2(64) not null,
  rev_              INTEGER,
  proc_inst_id_     NVARCHAR2(64),
...
;
create index AOS.AOS_ACT_IDX_EXEC_BUSKEY on AOS.AOS_ACT_RU_EXECUTION (BUSINESS_KEY_);
create index AOS.AOS_ACT_IDX_EXE_PARENT on AOS.AOS_ACT_RU_EXECUTION (PARENT_ID_);
create index AOS.AOS_ACT_IDX_EXE_PROCDEF on AOS.AOS_ACT_RU_EXECUTION (PROC_DEF_ID_);
create index AOS.AOS_ACT_IDX_EXE_PROCINST on AOS.AOS_ACT_RU_EXECUTION (PROC_INST_ID_);
create index AOS.AOS_ACT_IDX_EXE_SUPER on AOS.AOS_ACT_RU_EXECUTION (SUPER_EXEC_);
alter table AOS.AOS_ACT_RU_EXECUTION
  add primary key (ID_);
alter table AOS.AOS_ACT_RU_EXECUTION
  add constraint AOS_ACT_FK_EXE_PARENT foreign key (PARENT_ID_)
  references AOS.AOS_ACT_RU_EXECUTION (ID_);
alter table AOS.AOS_ACT_RU_EXECUTION
  add constraint AOS_ACT_FK_EXE_PROCDEF foreign key (PROC_DEF_ID_)
  references AOS.AOS_ACT_RE_PROCDEF (ID_);
alter table AOS.AOS_ACT_RU_EXECUTION
...
prompt ======================================
prompt
create table AOS.AOS_ACT_RU_EVENT_SUBSCR
(
  id_            NVARCHAR2(64) not null,
  rev_           INTEGER,
...
;
create index AOS.AOS_ACT_IDX_EVENT_SUBSCR on AOS.AOS_ACT_RU_EVENT_SUBSCR (EXECUTION_ID_);
create index AOS.AOS_ACT_IDX_EVENT_SUB_CFG on AOS.AOS_ACT_RU_EVENT_SUBSCR (CONFIGURATION_);
alter table AOS.AOS_ACT_RU_EVENT_SUBSCR
  add primary key (ID_);
alter table AOS.AOS_ACT_RU_EVENT_SUBSCR
...
prompt ==============================
prompt
create table AOS.AOS_ACT_RU_TASK
(
  id_               NVARCHAR2(64) not null,
  rev_              INTEGER,
  execution_id_     NVARCHAR2(64),
...
;
create index AOS.AOS_ACT_IDX_TASK_CREATE on AOS.AOS_ACT_RU_TASK (CREATE_TIME_);
create index AOS.AOS_ACT_IDX_TASK_EXEC on AOS.AOS_ACT_RU_TASK (EXECUTION_ID_);
create index AOS.AOS_ACT_IDX_TASK_PROCDEF on AOS.AOS_ACT_RU_TASK (PROC_DEF_ID_);
create index AOS.AOS_ACT_IDX_TASK_PROCINST on AOS.AOS_ACT_RU_TASK (PROC_INST_ID_);
alter table AOS.AOS_ACT_RU_TASK
  add primary key (ID_);
alter table AOS.AOS_ACT_RU_TASK
...
prompt ======================================
prompt
create table AOS.AOS_ACT_RU_IDENTITYLINK
(
  id_           NVARCHAR2(64) not null,
  rev_          INTEGER,
  group_id_     NVARCHAR2(255),
...
;
create index AOS.AOS_ACT_IDX_ATHRZ_PROCEDEF on AOS.AOS_ACT_RU_IDENTITYLINK (PROC_DEF_ID_);
create index AOS.AOS_ACT_IDX_IDENT_LNK_GROUP on AOS.AOS_ACT_RU_IDENTITYLINK (GROUP_ID_);
create index AOS.AOS_ACT_IDX_IDENT_LNK_USER on AOS.AOS_ACT_RU_IDENTITYLINK (USER_ID_);
create index AOS.AOS_ACT_IDX_IDL_PROCINST on AOS.AOS_ACT_RU_IDENTITYLINK (PROC_INST_ID_);
create index AOS.AOS_ACT_IDX_TSKASS_TASK on AOS.AOS_ACT_RU_IDENTITYLINK (TASK_ID_);
alter table AOS.AOS_ACT_RU_IDENTITYLINK
  add primary key (ID_);
alter table AOS.AOS_ACT_RU_IDENTITYLINK
...
alter table AOS.AOS_ACT_RU_IDENTITYLINK
  ...
  references AOS.AOS_ACT_RU_TASK (ID_);

prompt
prompt Creating table AOS_ACT_RU_JOB
prompt =============================
prompt
create table AOS.AOS_ACT_RU_JOB
(
  id_                  NVARCHAR2(64) not null,
  rev_                 INTEGER,
  type_                NVARCHAR2(255) not null,
...
;
create index AOS.AOS_ACT_IDX_JOB_EXCEPTION on AOS.AOS_ACT_RU_JOB (EXCEPTION_STACK_ID_);
alter table AOS.AOS_ACT_RU_JOB
  add primary key (ID_);
alter table AOS.AOS_ACT_RU_JOB
...
prompt ==================================
prompt
create table AOS.AOS_ACT_RU_VARIABLE
(
  id_           NVARCHAR2(64) not null,
  rev_          INTEGER,
  type_         NVARCHAR2(255) not null,
...
;
create index AOS.AOS_ACT_IDX_VARIABLE_TASK_ID on AOS.AOS_ACT_RU_VARIABLE (TASK_ID_);
create index AOS.AOS_ACT_IDX_VAR_BYTEARRAY on AOS.AOS_ACT_RU_VARIABLE (BYTEARRAY_ID_);
create index AOS.AOS_ACT_IDX_VAR_EXE on AOS.AOS_ACT_RU_VARIABLE (EXECUTION_ID_);
create index AOS.AOS_ACT_IDX_VAR_PROCINST on AOS.AOS_ACT_RU_VARIABLE (PROC_INST_ID_);
alter table AOS.AOS_ACT_RU_VARIABLE
  add primary key (ID_);
alter table AOS.AOS_ACT_RU_VARIABLE
...
prompt ================================
prompt
create table AOS.AOS_SYS_BYTEARRAY
(
...
;
comment on table AOS.AOS_SYS_BYTEARRAY
  is '流文件表';
comment on column AOS.AOS_SYS_BYTEARRAY.id_
  is '流水号';
comment on column AOS.AOS_SYS_BYTEARRAY.key_
  is '标识键';
comment on column AOS.AOS_SYS_BYTEARRAY.name_
  is '名称';
comment on column AOS.AOS_SYS_BYTEARRAY.catalog_id_
  is '分类ID';
comment on column AOS.AOS_SYS_BYTEARRAY.catalog_cascade_id_
  is '分类级联ID';
comment on column AOS.AOS_SYS_BYTEARRAY.content_type_
  is '内容类型';
comment on column AOS.AOS_SYS_BYTEARRAY.size_
  is '大小';
comment on column AOS.AOS_SYS_BYTEARRAY.bytes_
  is '流文件';
comment on column AOS.AOS_SYS_BYTEARRAY.create_time_
  is '创建时间';
comment on column AOS.AOS_SYS_BYTEARRAY.creater_id_
  is '操作人ID';
comment on column AOS.AOS_SYS_BYTEARRAY.title_
  is '标题';
comment on column AOS.AOS_SYS_BYTEARRAY.remark_
  is '备注';
create unique index AOS.AOS_SYS_BYTEARRAY_UKEY on AOS.AOS_SYS_BYTEARRAY (KEY_);
alter table AOS.AOS_SYS_BYTEARRAY
...
prompt ==============================
prompt
create table AOS.AOS_SYS_CATALOG
(
  id_             VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_CATALOG
  is '分类表';
comment on column AOS.AOS_SYS_CATALOG.id_
  is '流水号';
comment on column AOS.AOS_SYS_CATALOG.cascade_id_
  is '节点语义ID';
comment on column AOS.AOS_SYS_CATALOG.root_key_
  is '科目标识键';
comment on column AOS.AOS_SYS_CATALOG.root_name_
  is '科目名称';
comment on column AOS.AOS_SYS_CATALOG.name_
  is '分类名称';
comment on column AOS.AOS_SYS_CATALOG.hotkey_
  is '热键';
comment on column AOS.AOS_SYS_CATALOG.parent_id_
  is '父节点流水号';
comment on column AOS.AOS_SYS_CATALOG.is_leaf_
  is '是否叶子节点';
comment on column AOS.AOS_SYS_CATALOG.is_auto_expand_
  is '是否自动展开';
comment on column AOS.AOS_SYS_CATALOG.icon_name_
  is '图标文件名称';
comment on column AOS.AOS_SYS_CATALOG.sort_no_
  is '排序号';
create unique index AOS.AOS_SYS_CATALOG_UKEY on AOS.AOS_SYS_CATALOG (CASCADE_ID_);
alter table AOS.AOS_SYS_CATALOG
...
;
comment on table AOS.AOS_SYS_DIC
  is '数据字典明细表';
comment on column AOS.AOS_SYS_DIC.id_
  is '流水号';
comment on column AOS.AOS_SYS_DIC.code_
  is '字典对照码';
comment on column AOS.AOS_SYS_DIC.desc_
  is '字典对照值';
comment on column AOS.AOS_SYS_DIC.hotkey_
  is ' 热键';
comment on column AOS.AOS_SYS_DIC.status_
  is '当前状态';
comment on column AOS.AOS_SYS_DIC.dic_index_id_
  is '所属字典流水号';
comment on column AOS.AOS_SYS_DIC.remark_
  is '备注';
alter table AOS.AOS_SYS_DIC
...
prompt ================================
prompt
create table AOS.AOS_SYS_DIC_INDEX
(
  id_                 VARCHAR2(64) not null,
  key_                VARCHAR2(255) not null,
  name_               VARCHAR2(255) not null,
...
;
comment on table AOS.AOS_SYS_DIC_INDEX
  is '数据字典索引表';
comment on column AOS.AOS_SYS_DIC_INDEX.id_
  is '流水号';
comment on column AOS.AOS_SYS_DIC_INDEX.key_
  is '字典标识';
comment on column AOS.AOS_SYS_DIC_INDEX.name_
  is '字典名称';
comment on column AOS.AOS_SYS_DIC_INDEX.hotkey_
  is '热键';
comment on column AOS.AOS_SYS_DIC_INDEX.catalog_id_
  is '所属分类流水号';
comment on column AOS.AOS_SYS_DIC_INDEX.catalog_cascade_id_
  is '所属分类流节点语义ID';
comment on column AOS.AOS_SYS_DIC_INDEX.remark_
  is '备注';
create unique index AOS.AOS_SYS_DIC_INDEX_UKEY on AOS.AOS_SYS_DIC_INDEX (KEY_);
alter table AOS.AOS_SYS_DIC_INDEX
...
;
comment on table AOS.AOS_SYS_ICON
  is '图标大全';
comment on column AOS.AOS_SYS_ICON.id_
  is '流水号';
comment on column AOS.AOS_SYS_ICON.name_
  is '名称';
comment on column AOS.AOS_SYS_ICON.type_
  is '类型';
create index AOS.AOS_SYS_ICON_UKEY on AOS.AOS_SYS_ICON (NAME_, TYPE_);
alter table AOS.AOS_SYS_ICON
...
prompt =============================
prompt
create table AOS.AOS_SYS_MODULE
(
  id_             VARCHAR2(64) not null,
  cascade_id_     VARCHAR2(255) not null,
  name_           VARCHAR2(255) not null,
...
;
comment on table AOS.AOS_SYS_MODULE
  is '功能模块表';
comment on column AOS.AOS_SYS_MODULE.id_
  is '功能模块流水号';
comment on column AOS.AOS_SYS_MODULE.cascade_id_
  is '节点语义ID';
comment on column AOS.AOS_SYS_MODULE.name_
  is '功能模块名称';
comment on column AOS.AOS_SYS_MODULE.url_
  is '主页面URL';
comment on column AOS.AOS_SYS_MODULE.hotkey_
  is '热键';
comment on column AOS.AOS_SYS_MODULE.parent_id_
  is '父节点流水号';
comment on column AOS.AOS_SYS_MODULE.is_leaf_
  is '是否叶子节点';
comment on column AOS.AOS_SYS_MODULE.is_auto_expand_
  is '是否自动展开';
comment on column AOS.AOS_SYS_MODULE.icon_name_
  is '节点图标文件名称';
comment on column AOS.AOS_SYS_MODULE.status_
  is '当前状态';
comment on column AOS.AOS_SYS_MODULE.parent_name_
  is '父节点名称';
comment on column AOS.AOS_SYS_MODULE.vector_
  is '矢量图标';
comment on column AOS.AOS_SYS_MODULE.sort_no_
  is '排序号';
alter table AOS.AOS_SYS_MODULE
...
prompt ==================================
prompt
create table AOS.AOS_SYS_MODULE_POST
(
  id_           VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_MODULE_POST
  is '功能模块-岗位关联表';
comment on column AOS.AOS_SYS_MODULE_POST.id_
  is '流水号';
comment on column AOS.AOS_SYS_MODULE_POST.post_id_
  is '岗位流水号';
comment on column AOS.AOS_SYS_MODULE_POST.module_id_
  is '功能模块流水号';
comment on column AOS.AOS_SYS_MODULE_POST.grant_type_
  is '权限类型(岗位仅提供经办权限)';
comment on column AOS.AOS_SYS_MODULE_POST.operate_time_
  is '授权时间';
comment on column AOS.AOS_SYS_MODULE_POST.operator_id_
  is '授权人流水号';
create index AOS.AOS_SYS_MODULE_POST_UKEY on AOS.AOS_SYS_MODULE_POST (POST_ID_, MODULE_ID_, GRANT_TYPE_);
alter table AOS.AOS_SYS_MODULE_POST
...
prompt ==================================
prompt
create table AOS.AOS_SYS_MODULE_ROLE
(
  id_           VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_MODULE_ROLE
  is '功能模块-角色关联表';
comment on column AOS.AOS_SYS_MODULE_ROLE.id_
  is '流水号';
comment on column AOS.AOS_SYS_MODULE_ROLE.role_id_
  is ' 角色流水号';
comment on column AOS.AOS_SYS_MODULE_ROLE.module_id_
  is '功能模块流水号';
comment on column AOS.AOS_SYS_MODULE_ROLE.grant_type_
  is '权限类型';
comment on column AOS.AOS_SYS_MODULE_ROLE.operate_time_
  is '授权时间';
comment on column AOS.AOS_SYS_MODULE_ROLE.operator_id_
  is '授权人流水号';
create index AOS.AOS_SYS_MOOLE_ROLE_UKEY on AOS.AOS_SYS_MODULE_ROLE (ROLE_ID_, MODULE_ID_, GRANT_TYPE_);
alter table AOS.AOS_SYS_MODULE_ROLE
...
prompt ==================================
prompt
create table AOS.AOS_SYS_MODULE_USER
(
  id_           VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_MODULE_USER
  is '功能模块-用户关联表';
comment on column AOS.AOS_SYS_MODULE_USER.id_
  is '流水号';
comment on column AOS.AOS_SYS_MODULE_USER.user_id_
  is ' 用户流水号';
comment on column AOS.AOS_SYS_MODULE_USER.module_id_
  is '功能模块流水号';
comment on column AOS.AOS_SYS_MODULE_USER.grant_type_
  is '权限类型';
comment on column AOS.AOS_SYS_MODULE_USER.operate_time_
  is '授权时间';
comment on column AOS.AOS_SYS_MODULE_USER.operator_id_
  is '授权人';
create index AOS.AOS_SYS_MODULE_USER_UKEY on AOS.AOS_SYS_MODULE_USER (USER_ID_, MODULE_ID_, GRANT_TYPE_);
alter table AOS.AOS_SYS_MODULE_USER
...
prompt ======================================
prompt
create table AOS.AOS_SYS_MODULE_USER_NAV
(
  id_        VARCHAR2(64) not null,
  module_id_ VARCHAR2(64) not null,
  user_id_   VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_MODULE_USER_NAV
  is '功能模块-用户关联表(浮动导航|快捷导航)';
comment on column AOS.AOS_SYS_MODULE_USER_NAV.id_
  is '流水号';
comment on column AOS.AOS_SYS_MODULE_USER_NAV.module_id_
  is '功能模块流水号';
comment on column AOS.AOS_SYS_MODULE_USER_NAV.user_id_
  is '人员流水号';
comment on column AOS.AOS_SYS_MODULE_USER_NAV.nav_icon_
  is '浮动导航图标文件';
comment on column AOS.AOS_SYS_MODULE_USER_NAV.type_
  is '导航类型';
comment on column AOS.AOS_SYS_MODULE_USER_NAV.sort_no_
  is '排序号';
create index AOS.AOS_SYS_MODULE_USER_NAV_UKEY on AOS.AOS_SYS_MODULE_USER_NAV (MODULE_ID_, USER_ID_, TYPE_);
alter table AOS.AOS_SYS_MODULE_USER_NAV
...
;
comment on table AOS.AOS_SYS_ORG
  is '组织表';
comment on column AOS.AOS_SYS_ORG.id_
  is '流水号';
comment on column AOS.AOS_SYS_ORG.cascade_id_
  is '节点语义ID';
comment on column AOS.AOS_SYS_ORG.name_
  is '组织名称';
comment on column AOS.AOS_SYS_ORG.hotkey_
  is '热键';
comment on column AOS.AOS_SYS_ORG.parent_id_
  is '父节点流水号';
comment on column AOS.AOS_SYS_ORG.pareant_name_
  is '父节点名称';
comment on column AOS.AOS_SYS_ORG.is_leaf_
  is '是否叶子节点';
comment on column AOS.AOS_SYS_ORG.is_auto_expand_
  is '是否自动展开';
comment on column AOS.AOS_SYS_ORG.icon_name_
  is '节点图标文件名称';
comment on column AOS.AOS_SYS_ORG.status_
  is '当前状态';
comment on column AOS.AOS_SYS_ORG.type_
  is '组织类型';
comment on column AOS.AOS_SYS_ORG.biz_code_
  is '业务对照码';
comment on column AOS.AOS_SYS_ORG.custom_code_
  is '自定义扩展码';
comment on column AOS.AOS_SYS_ORG.create_time_
  is '创建时间';
comment on column AOS.AOS_SYS_ORG.creater_id_
  is '创建人ID';
comment on column AOS.AOS_SYS_ORG.sort_no_
  is '排序号';
alter table AOS.AOS_SYS_ORG
...
;
comment on table AOS.AOS_SYS_PAGE
  is '模块页面表';
comment on column AOS.AOS_SYS_PAGE.id_
  is '流水号';
comment on column AOS.AOS_SYS_PAGE.module_id_
  is '功能模块ID';
comment on column AOS.AOS_SYS_PAGE.name_
  is '名称';
comment on column AOS.AOS_SYS_PAGE.url_
  is '页面URL';
comment on column AOS.AOS_SYS_PAGE.type_
  is '类型';
comment on column AOS.AOS_SYS_PAGE.enabled_
  is '使能状态';
comment on column AOS.AOS_SYS_PAGE.is_default_
  is '是否缺省子页面';
comment on column AOS.AOS_SYS_PAGE.icon_
  is '小图标';
comment on column AOS.AOS_SYS_PAGE.icon_big_
  is '大图标';
comment on column AOS.AOS_SYS_PAGE.vector_
  is '矢量图标';
comment on column AOS.AOS_SYS_PAGE.sort_no_
  is '排序号';
alter table AOS.AOS_SYS_PAGE
...
prompt ==============================
prompt
create table AOS.AOS_SYS_PAGE_EL
(
  id_        VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_PAGE_EL
  is '页面元素表';
comment on column AOS.AOS_SYS_PAGE_EL.id_
  is '流水号';
comment on column AOS.AOS_SYS_PAGE_EL.dom_id_
  is 'DOM ID';
comment on column AOS.AOS_SYS_PAGE_EL.name_
  is '名称';
comment on column AOS.AOS_SYS_PAGE_EL.type_
  is '类型';
comment on column AOS.AOS_SYS_PAGE_EL.module_id_
  is '所属功能模块流水号';
comment on column AOS.AOS_SYS_PAGE_EL.page_id_
  is '页面ID';
comment on column AOS.AOS_SYS_PAGE_EL.remark_
  is '备注';
create index AOS.AOS_SYS_PAGE_EL_UKEY on AOS.AOS_SYS_PAGE_EL (DOM_ID_, MODULE_ID_, PAGE_ID_);
alter table AOS.AOS_SYS_PAGE_EL
...
prompt ====================================
prompt
create table AOS.AOS_SYS_PAGE_EL_GRANT
(
  id_         VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_PAGE_EL_GRANT
  is '页面元素授权表';
comment on column AOS.AOS_SYS_PAGE_EL_GRANT.id_
  is '流水号';
comment on column AOS.AOS_SYS_PAGE_EL_GRANT.el_id_
  is '页面元素流水号';
comment on column AOS.AOS_SYS_PAGE_EL_GRANT.user_id_
  is '用户流水号';
comment on column AOS.AOS_SYS_PAGE_EL_GRANT.role_id_
  is '角色流水号';
comment on column AOS.AOS_SYS_PAGE_EL_GRANT.post_id_
  is '岗位流水号';
comment on column AOS.AOS_SYS_PAGE_EL_GRANT.grant_type_
  is '权限类型';
alter table AOS.AOS_SYS_PAGE_EL_GRANT
...
prompt ============================
prompt
create table AOS.AOS_SYS_PARAM
(
  id_                 VARCHAR2(64) not null,
  key_                VARCHAR2(255) not null,
  value_              VARCHAR2(255),
...
;
comment on table AOS.AOS_SYS_PARAM
  is '参数表';
comment on column AOS.AOS_SYS_PARAM.id_
  is '流水号';
comment on column AOS.AOS_SYS_PARAM.key_
  is '参数键';
comment on column AOS.AOS_SYS_PARAM.value_
  is '参数值';
comment on column AOS.AOS_SYS_PARAM.catalog_id_
  is '所属分类流水号';
comment on column AOS.AOS_SYS_PARAM.catalog_cascade_id_
  is '所属分类节点语义ID';
comment on column AOS.AOS_SYS_PARAM.name_
  is '参数名称';
comment on column AOS.AOS_SYS_PARAM.is_overwrite_
  is '是否可覆盖';
comment on column AOS.AOS_SYS_PARAM.overwrite_field_
  is '覆盖来源字段';
comment on column AOS.AOS_SYS_PARAM.remark_
  is '备注';
create unique index AOS.AOS_SYS_PARAM_UKEY on AOS.AOS_SYS_PARAM (KEY_);
alter table AOS.AOS_SYS_PARAM
...
;
comment on table AOS.AOS_SYS_POST
  is '岗位表';
comment on column AOS.AOS_SYS_POST.id_
  is ' 流水号';
comment on column AOS.AOS_SYS_POST.name_
  is '岗位名称';
comment on column AOS.AOS_SYS_POST.status_
  is '当前状态';
comment on column AOS.AOS_SYS_POST.type_
  is '岗位类型';
comment on column AOS.AOS_SYS_POST.org_id_
  is '所属部门流水号';
comment on column AOS.AOS_SYS_POST.create_time_
  is '创建时间';
comment on column AOS.AOS_SYS_POST.creater_id_
  is '创建人ID';
comment on column AOS.AOS_SYS_POST.org_cascade_id_
  is '所属部门节点语义ID';
alter table AOS.AOS_SYS_POST
...
;
comment on table AOS.AOS_SYS_ROLE
  is '角色表';
comment on column AOS.AOS_SYS_ROLE.id_
  is ' 流水号';
comment on column AOS.AOS_SYS_ROLE.name_
  is '角色名称';
comment on column AOS.AOS_SYS_ROLE.status_
  is '当前状态';
comment on column AOS.AOS_SYS_ROLE.type_
  is '角色类型';
comment on column AOS.AOS_SYS_ROLE.create_time_
  is '创建时间';
comment on column AOS.AOS_SYS_ROLE.creater_id_
  is '创建人ID';
comment on column AOS.AOS_SYS_ROLE.creater_org_id_
  is '创建人所属部门流水号';
comment on column AOS.AOS_SYS_ROLE.creater_org_cascade_id_
  is '创建人所属部门节点语义ID';
alter table AOS.AOS_SYS_ROLE
...
prompt ===============================
prompt
create table AOS.AOS_SYS_SEQUENCE
(
  id_           VARCHAR2(64) not null,
  name_         VARCHAR2(255) not null,
  type_         VARCHAR2(255),
...
;
comment on table AOS.AOS_SYS_SEQUENCE
  is 'ID配置表';
comment on column AOS.AOS_SYS_SEQUENCE.id_
  is '流水号';
comment on column AOS.AOS_SYS_SEQUENCE.name_
  is '名称';
comment on column AOS.AOS_SYS_SEQUENCE.type_
  is '类型';
comment on column AOS.AOS_SYS_SEQUENCE.prefix_
  is '前缀';
comment on column AOS.AOS_SYS_SEQUENCE.start_
  is '起始值';
comment on column AOS.AOS_SYS_SEQUENCE.step_
  is '递增步长';
comment on column AOS.AOS_SYS_SEQUENCE.cur_value_
  is '当前值';
comment on column AOS.AOS_SYS_SEQUENCE.status_
  is '当前状态';
comment on column AOS.AOS_SYS_SEQUENCE.connector_
  is '连接符';
comment on column AOS.AOS_SYS_SEQUENCE.suffix_
  is '后缀';
comment on column AOS.AOS_SYS_SEQUENCE.db_seq_name_
  is 'DBSequence名称';
comment on column AOS.AOS_SYS_SEQUENCE.max_value_
  is '最大值';
comment on column AOS.AOS_SYS_SEQUENCE.is_circul_
  is '是否循环';
comment on column AOS.AOS_SYS_SEQUENCE.min_value_
  is '最小值';
comment on column AOS.AOS_SYS_SEQUENCE.is_leftpad_
  is '是否左补足';
comment on column AOS.AOS_SYS_SEQUENCE.format_value_
  is '当前格式化值';
comment on column AOS.AOS_SYS_SEQUENCE.remark_
  is '备注';
create unique index AOS.AOS_SYS_SEQUENCE_UKEY on AOS.AOS_SYS_SEQUENCE (NAME_);
alter table AOS.AOS_SYS_SEQUENCE
...
;
comment on table AOS.AOS_SYS_USER
  is '用户基本信息表';
comment on column AOS.AOS_SYS_USER.id_
  is '流水号';
comment on column AOS.AOS_SYS_USER.account_
  is '用户登录帐号';
comment on column AOS.AOS_SYS_USER.password_
  is '密码';
comment on column AOS.AOS_SYS_USER.name_
  is '用户姓名';
comment on column AOS.AOS_SYS_USER.sex_
  is '性别';
comment on column AOS.AOS_SYS_USER.org_id_
  is '所属主部门流水号';
comment on column AOS.AOS_SYS_USER.status_
  is '用户状态';
comment on column AOS.AOS_SYS_USER.type_
  is '用户类型';
comment on column AOS.AOS_SYS_USER.biz_code_
  is '业务对照码';
comment on column AOS.AOS_SYS_USER.create_time_
  is ' 经办时间';
comment on column AOS.AOS_SYS_USER.creater_id_
  is '经办人流水号';
comment on column AOS.AOS_SYS_USER.org_cascade_id_
  is '所属部门节点语义ID';
create unique index AOS.AOS_SYS_USER_UKEY on AOS.AOS_SYS_USER (ACCOUNT_);
alter table AOS.AOS_SYS_USER
...
prompt ===============================
prompt
create table AOS.AOS_SYS_USER_CFG
(
  id_               VARCHAR2(64) not null,
  theme_            VARCHAR2(255),
  skin_             VARCHAR2(255),
...
;
comment on table AOS.AOS_SYS_USER_CFG
  is '用户配置表';
comment on column AOS.AOS_SYS_USER_CFG.id_
  is '用户ID';
comment on column AOS.AOS_SYS_USER_CFG.theme_
  is '用户界面主题';
comment on column AOS.AOS_SYS_USER_CFG.skin_
  is '用户界面皮肤';
comment on column AOS.AOS_SYS_USER_CFG.layout_
  is '系统业务经办区域布局风格';
comment on column AOS.AOS_SYS_USER_CFG.nav_mode_
  is '导航模式';
comment on column AOS.AOS_SYS_USER_CFG.is_show_top_nav_
  is '是否显示水平导航条';
comment on column AOS.AOS_SYS_USER_CFG.navbar_btn_style_
  is '导航条按钮风格';
comment on column AOS.AOS_SYS_USER_CFG.tab_focus_color_
  is 'Tab高亮颜色';
comment on column AOS.AOS_SYS_USER_CFG.is_show_mac_nav_
  is '欢迎页Mac导航显示开关';
comment on column AOS.AOS_SYS_USER_CFG.nav_tab_index_
  is '导航缺省活动页';
comment on column AOS.AOS_SYS_USER_CFG.nav_quick_layout_
  is '快捷菜单布局风格';
alter table AOS.AOS_SYS_USER_CFG
...
prompt ===============================
prompt
create table AOS.AOS_SYS_USER_EXT
(
  id_            VARCHAR2(64) not null,
  email_         VARCHAR2(255),
...
;
comment on table AOS.AOS_SYS_USER_EXT
  is '用户扩展信息表';
comment on column AOS.AOS_SYS_USER_EXT.id_
  is '用户ID';
comment on column AOS.AOS_SYS_USER_EXT.email_
  is '电子邮件';
comment on column AOS.AOS_SYS_USER_EXT.fixed_phone_
  is '固定电话';
comment on column AOS.AOS_SYS_USER_EXT.mobile_phone_
  is '移动电话';
comment on column AOS.AOS_SYS_USER_EXT.address_
  is '联系地址';
comment on column AOS.AOS_SYS_USER_EXT.zip_
  is '邮编';
comment on column AOS.AOS_SYS_USER_EXT.birthday_
  is '生日';
comment on column AOS.AOS_SYS_USER_EXT.idno_
  is '身份证号';
comment on column AOS.AOS_SYS_USER_EXT.qq_
  is 'QQ';
comment on column AOS.AOS_SYS_USER_EXT.dynamic_field_
  is '动态扩展字段';
comment on column AOS.AOS_SYS_USER_EXT.bytearray_id_
  is '用户头像流文件ID';
comment on column AOS.AOS_SYS_USER_EXT.remark_
  is '备注';
comment on column AOS.AOS_SYS_USER_EXT.filed1_
  is '静态扩展字段1';
comment on column AOS.AOS_SYS_USER_EXT.filed2_
  is '静态扩展字段2';
comment on column AOS.AOS_SYS_USER_EXT.filed3_
  is '静态扩展字段3';
alter table AOS.AOS_SYS_USER_EXT
...
prompt ================================
prompt
create table AOS.AOS_SYS_USER_POST
(
  id_           VARCHAR2(64) not null,
  user_id_      VARCHAR2(64) not null,
  post_id_      VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_USER_POST
  is '用户-岗位关联表';
comment on column AOS.AOS_SYS_USER_POST.id_
  is '流水号';
comment on column AOS.AOS_SYS_USER_POST.user_id_
  is '用户流水号';
comment on column AOS.AOS_SYS_USER_POST.post_id_
  is '岗位流水号';
comment on column AOS.AOS_SYS_USER_POST.operate_time_
  is '授权时间';
comment on column AOS.AOS_SYS_USER_POST.operator_id_
  is '授权人流水号';
create index AOS.AOS_SYS_USER_POST_UKEY on AOS.AOS_SYS_USER_POST (USER_ID_, POST_ID_);
alter table AOS.AOS_SYS_USER_POST
...
prompt ================================
prompt
create table AOS.AOS_SYS_USER_ROLE
(
  id_           VARCHAR2(64) not null,
  user_id_      VARCHAR2(64) not null,
  role_id_      VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_USER_ROLE
  is '用户-角色关联表';
comment on column AOS.AOS_SYS_USER_ROLE.id_
  is '流水号';
comment on column AOS.AOS_SYS_USER_ROLE.user_id_
  is '用户流水号';
comment on column AOS.AOS_SYS_USER_ROLE.role_id_
  is '角色流水号';
comment on column AOS.AOS_SYS_USER_ROLE.operate_time_
  is '授权时间';
comment on column AOS.AOS_SYS_USER_ROLE.operator_id_
  is '授权人流水号';
create index AOS.AOS_SYS_USER_ROLE_UKEY on AOS.AOS_SYS_USER_ROLE (USER_ID_, ROLE_ID_);
alter table AOS.AOS_SYS_USER_ROLE
...
prompt ===============================
prompt
create table AOS.AOS_SYS_WF_MODEL
(
  id_             VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_WF_MODEL
  is '流程模型扩展表';
comment on column AOS.AOS_SYS_WF_MODEL.id_
  is '流水号';
comment on column AOS.AOS_SYS_WF_MODEL.model_id_
  is '模型id';
comment on column AOS.AOS_SYS_WF_MODEL.create_type_
  is '模型创建方式';
comment on column AOS.AOS_SYS_WF_MODEL.name_
  is '流程名称';
comment on column AOS.AOS_SYS_WF_MODEL.create_user_id_
  is '创建人流水号';
comment on column AOS.AOS_SYS_WF_MODEL.create_user_
  is '创建人';
comment on column AOS.AOS_SYS_WF_MODEL.create_time_
  is '创建时间';
comment on column AOS.AOS_SYS_WF_MODEL.remark_
  is '备注';
create unique index AOS.AOS_SYS_WF_MODEL_UKEY on AOS.AOS_SYS_WF_MODEL (MODEL_ID_);
alter table AOS.AOS_SYS_WF_MODEL
...
prompt =================================
prompt
create table AOS.AOS_SYS_WF_PROCDEF
(
  id_             VARCHAR2(64) not null,
  model_id_       VARCHAR2(64) not null,
...
;
comment on table AOS.AOS_SYS_WF_PROCDEF
  is '流程定义扩展表';
comment on column AOS.AOS_SYS_WF_PROCDEF.id_
  is '流水号';
comment on column AOS.AOS_SYS_WF_PROCDEF.model_id_
  is '模型id';
comment on column AOS.AOS_SYS_WF_PROCDEF.proc_def_id_
  is '流程定义id';
comment on column AOS.AOS_SYS_WF_PROCDEF.deploy_user_id_
  is ' 部署人流水号';
comment on column AOS.AOS_SYS_WF_PROCDEF.deploy_user_
  is '部署人';
comment on column AOS.AOS_SYS_WF_PROCDEF.deploy_time_
  is '部署时间';
create unique index AOS.AOS_SYS_WF_PROCDEF_UKEY on AOS.AOS_SYS_WF_PROCDEF (PROC_DEF_ID_);
alter table AOS.AOS_SYS_WF_PROCDEF
...
prompt =================================
prompt
create sequence AOS.ACT_EVT_LOG_SEQ
minvalue 1
...
prompt Created on 2015年7月5日 by XChun
set feedback off
set define off
...
insert into AOS_SYS_DIC (id_, code_, desc_, hotkey_, status_, dic_index_id_, remark_)
values ('77', '1', '正常', null, '1', '76', null);
insert into AOS_SYS_DIC (id_, code_, desc_, hotkey_, status_, dic_index_id_, remark_)
values ('78', '2', '挂失', null, '1', '76', null);
insert into AOS_SYS_DIC (id_, code_, desc_, hotkey_, status_, dic_index_id_, remark_)
values ('79', '3', '注销', null, '1', '76', null);
insert into AOS_SYS_DIC (id_, code_, desc_, hotkey_, status_, dic_index_id_, remark_)
...
insert into AOS_SYS_DIC_INDEX (id_, key_, name_, hotkey_, catalog_id_, catalog_cascade_id_, remark_)
values ('76', 'az01b2', '银行卡状态', null, '75', '0.002.005', null);
insert into AOS_SYS_DIC_INDEX (id_, key_, name_, hotkey_, catalog_id_, catalog_cascade_id_, remark_)
...
values ('0', '0', 'OSWorks-AOS应用基础平台', null, null, 'p', '0', '1', 'home.png', '1', 'root', null, 1);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
...
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('183', '0.001', '控制台', null, null, '0', '0', '1', 'folder22.png', '1', 'OSWorks-AOS应用基础平台', 'fa-cogs', 10);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('184', '0.002', '工作台', null, null, '0', '0', '1', 'folder23.png', '1', 'OSWorks-AOS应用基础平台', 'fa-github-alt', 20);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
...
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('217', '0.001.008.006', 'DAO代码生成', 'system/daoCoder/init.jhtml', null, '555', '1', '0', 'icon66.png', '1', '开发工具', null, 20);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('220', '0.001.008.003', '视图页面设计', null, null, '555', '1', '0', 'icon88.png', '1', '开发工具', null, 31);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('222', '0.001.008.004', '新增模块向导', null, null, '555', '1', '0', 'icon65.png', '1', '开发工具', null, 32);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('225', '0.001.008.002', 'WebSQL', 'system/webSql/init.jhtml', null, '555', '1', '0', 'sql.png', '1', '开发工具', null, 11);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
...
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('236', '0.004', '演示', null, null, '0', '0', '1', 'folder27.png', '1', 'OSWorks-AOS应用基础平台', 'fa-coffee', 40);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
...
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('393', '0.001.008.001', '图标大全', 'system/icon/init.jhtml', null, '555', '1', '0', 'page_picture.png', '1', '开发工具', null, 90);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
...
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
values ('555', '0.001.008', '开发工具', null, null, '183', '0', '0', 'folder9.png', '1', '控制台', 'fa-bug', 70);
insert into AOS_SYS_MODULE (id_, cascade_id_, name_, url_, hotkey_, parent_id_, is_leaf_, is_auto_expand_, icon_name_, status_, parent_name_, vector_, sort_no_)
...
insert into AOS_SYS_PARAM (id_, key_, value_, catalog_id_, catalog_cascade_id_, name_, is_overwrite_, overwrite_field_, remark_)
values ('363', 'app_title_', 'AOS应用基础平台', '413', '0.001.002.002', '首页浏览器标题内容', '0', null, '首页浏览器标题内容');
insert into AOS_SYS_PARAM (id_, key_, value_, catalog_id_, catalog_cascade_id_, name_, is_overwrite_, overwrite_field_, remark_)
...
insert into AOS_SYS_PARAM (id_, key_, value_, catalog_id_, catalog_cascade_id_, name_, is_overwrite_, overwrite_field_, remark_)
values ('74', 'app_name_', 'AOS应用基础平台', '413', '0.001.002.002', '应用系统名称', '0', null, '应用系统名称');
commit;
...
values ('1', 'GID', '1', null, '1', '1', '1718', '1', null, null, null, '9999999999', '0', '1', '0', '1718', '系统管理-实体表流水号。');
insert into AOS_SYS_SEQUENCE (id_, name_, type_, prefix_, start_, step_, cur_value_, status_, connector_, suffix_, db_seq_name_, max_value_, is_circul_, min_value_, is_leftpad_, format_value_, remark_)
...
insert into AOS_SYS_SEQUENCE (id_, name_, type_, prefix_, start_, step_, cur_value_, status_, connector_, suffix_, db_seq_name_, max_value_, is_circul_, min_value_, is_leftpad_, format_value_, remark_)
values ('546', 'BPMID', '1', null, '1', '1', '121', '1', null, null, null, '9999999999', '0', '1', '0', '121', '流程引擎相关辅助表的流水号');
insert into AOS_SYS_SEQUENCE (id_, name_, type_, prefix_, start_, step_, cur_value_, status_, connector_, suffix_, db_seq_name_, max_value_, is_circul_, min_value_, is_leftpad_, format_value_, remark_)
...
values ('1', '307916217@qq.com', null, '18616786188', null, null, null, null, '307916217', null, '1718', '超级用户拥有系统最高权限。', null, null, null);
insert into AOS_SYS_USER_EXT (id_, email_, fixed_phone_, mobile_phone_, address_, zip_, birthday_, idno_, qq_, dynamic_field_, bytearray_id_, remark_, filed1_, filed2_, filed3_)
...
insert into AOS_SYS_WF_MODEL (id_, model_id_, create_type_, name_, create_user_id_, create_user_, create_time_, remark_)
values ('119', '1', '1', '测试', '1', '超级用户', '2015-06-28 00:35:25', '测试');
commit;
