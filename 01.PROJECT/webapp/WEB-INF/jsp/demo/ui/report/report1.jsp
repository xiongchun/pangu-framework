	...
	<script type="text/javascript">
		...
		function fn_html(){
            AOS.ajax({
                ...
                ok: function (data) {
                	 parent.fnaddtab('${param.aos_module_id_ }_1', '预览HTML报表', 'report/html.jhtml');
                }
            });
		}
		...
		function fn_pdf(){
            AOS.ajax({
                url: 'fillReport.jhtml',
                ok: function (data) {
                	 parent.fnaddtab('${param.aos_module_id_ }_2', '预览PDF报表', 'report/pdf.jhtml');
                }
            });
		}
