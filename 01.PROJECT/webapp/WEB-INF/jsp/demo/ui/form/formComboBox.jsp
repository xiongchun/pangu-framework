	...
	<aos:viewport>
		<aos:formpanel id="_f_info" autoShow="true" width="650" layout="column" title="组合选择框" icon="icon152.png"
			...
			<aos:fieldset title="下拉树选择框" labelWidth="90" columnWidth="1">
				<aos:treepicker fieldLabel="所属分类" name="catalog_id_" allowBlank="false" id="_tp_catalog_id_" emptyText="请选择..."
					rootId="10" url="listCatalogs.jhtml" nodeParam="parent_id_" columnWidth="0.5" />
			</aos:fieldset>
		...
		<aos:window id="_w_org_find" title="上级组织[双击选择]" height="-60" layout="fit" autoScroll="true"
			...
			<aos:treepanel id="_t_org_find" singleClick="false" width="320" bodyBorder="0 0 0 0" url="listOrgTree.jhtml"
				nodeParam="parent_id_" rootId="0" rootText="中国嘉靖银行" rootVisible="true" rootIcon="home.png" rootExpanded="false"
				onitemdblclick="_t_org_find_select" />
		</aos:window>
