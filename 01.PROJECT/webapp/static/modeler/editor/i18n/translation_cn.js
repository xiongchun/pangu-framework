...
ORYX.I18N.Language = "zh-cn"; //Pattern <ISO language code>_<ISO country code> in lower case!
...
ORYX.I18N.Save.unsavedData = "模型数据尚未保存，请先保存数据。继续离开，数据将丢失。";
...
ORYX.I18N.PropertyWindow.complex = "请输入";
ORYX.I18N.PropertyWindow.text = "请输入";
...
ORYX.I18N.ShapeRepository.title = "流程模型图元库";
