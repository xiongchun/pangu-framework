...
<div id="div_content"  class="x-hidden">
AOS开发套件基于JavaEE技术体系，以“标准功能可复用、通用模块可配置、行业需求快速开发、异构系统无缝集成”为目标，
...
<aos:onready>
	<aos:viewport>
	        <c:if test="${run_mode_ == '2'}">
			 	<aos:panel iconVec="fa-bullhorn" iconVecSize="16"  contentEl="div_content" width="600" y="40" x="40" title="关于AOS开发套件[100%无死角免费又开源]">
